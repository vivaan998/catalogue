...
CREATE TABLE IF NOT EXISTS SessionTranslation
(
  SessionUUID VARCHAR(36) NOT NULL,
  LanguageISO VARCHAR(2),
  Field VARCHAR(128),
  Value TEXT,
  CONSTRAINT PK_Translation PRIMARY KEY (SessionUUID,LanguageISO,Field),
  CONSTRAINT FK_STX_SessionUUID FOREIGN KEY (SessionUUID) REFERENCES Session (UUID) ON DELETE CASCADE
);
...
(
  ...
  Hashtag VARCHAR(256) NOT NULL,
  LanguageISO VARCHAR(2),
  CONSTRAINT PK_SessionTag PRIMARY KEY (SessionUUID, Hashtag),
