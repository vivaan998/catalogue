...
def _populate_avaibility_model(table_type, uuid, maxSlots, bookedSlots):
...
def write(liveUUID, maxSlots):
    ...
    sql_availability_table = _populate_avaibility_model(availability_table, liveUUID, maxSlots, 0)
